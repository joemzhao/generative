...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate):
        ...
        self.sequence_length = self.lstm.fuser.cand_max_len
        ...
        ###################################################################################
        self.h0 = self.lstm.fuser.final_features
    ...
    def get_reward(self, sess, input_x, rollout_num, discriminator, candidates):
        rewards = []
        for i in range(rollout_num):
            for given_num in range(1, self.sequence_length):
                feed = {self.x: input_x, self.given_num: given_num, self.lstm.fuser.input_ph: np.expand_dims(np.asarray(candidates), axis=0)}
