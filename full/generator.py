...
class Generator(object):
    def __init__(self, fuser=None, num_emb=20525, batch_size=1, emb_dim=256, hidden_dim=64,
        ...
        Including Ws and Bs from filters in convolution to the parameters of the
        generator.
        '''
        all_vars = tf.trainable_variables()
        fuser_vars = [var for var in all_vars if "fuser" in var.name]
        self.g_params.extend(fuser_vars)
