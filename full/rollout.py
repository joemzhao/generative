...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate):
        ...
        self.sequence_length = self.lstm.fuser.candidate_max_length
    ...
    def get_reward(self, sess, input_x, rollout_num, discriminator):
        ...
        for i in range(rollout_num):
            for given_num in range(1, self.sequence_length):
                candidates_tofeed = self.lstm.fuser.get_candidates_tofeed()
                feed = {self.x: input_x, self.given_num: given_num, self.lstm.fuser.input_ph: candidates_tofeed}
