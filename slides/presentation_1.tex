...
\author[Mengjie Zhao \and Fei Mi]{\underline{Mengjie Zhao}  \and Fei Mi } % Your name
...
%------------------------------------------------
\section{Problem definition: generating in discrete space?}
%------------------------------------------------

\begin{frame}
\frametitle{Generating in discrete space?}
\begin{itemize}
\item Differentiable generator and discriminator
\item But for text generation?
	\begin{itemize}
		\item word embedding
		\item policy iteration
		\item categorical reparameterization (gumbel-softmax) ...
...
%------------------------------------------------
\section{Rate of progress -- week 1}
%------------------------------------------------

\begin{frame}
\frametitle{Rate of progress -- week 1}
A toy GAN for MNIST: 
