...
class Dis_dataloader(object):
    def __init__(self, vocab_size=50, sequence_len=10):
...
if __name__ == "__main__":
    positive_file = 'text_data/partial_real.txt'
    negative_file = 'target_generate/eval_file_of_pretrain.txt'
    obj = Dis_dataloader(vocab_size=20520, sequence_len=10)
    obj.load_data_n_labels(positive_file, negative_file)
