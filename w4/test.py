...
_, _, logits, _, _, dec_states = encoder_decoder._seq2seq()
...
# beam_predictor(enc_inp, encoder_decoder, top_value,
#                                top_index, dec_states,
#                                top_k,  max_seq_len, signal=None):
...
if interactive:
    ...
    while True:
        ...
        max_seq_len=max_seq_len, sess=sess, signal=None)
